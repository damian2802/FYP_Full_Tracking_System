...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $hashedPassword = password_hash($myusername, PASSWORD_DEFAULT);
  ...
  <body>
    <div class="container-fluid">
      <div class="row min-vh-100">
        <div class="col-md-4 d-none d-md-flex bg-dark justify-content-center align-items-center">
          <img src="assets/Color3D_for Dark Background.png" class="img-fluid" alt="...">
        </div>
        <div class="col-12 col-md-8 d-flex flex-column justify-content-center align-items-center bg-light">
          <div class="w-100 p-3" style="max-width: 400px;">
            <h1 class="text-center">Welcome to FYP Full Tracking System</h1>
            <form action="" method="post">
              ...
              <?php echo "<strong class='text-danger mt-3 d-block'>$error</strong>"; ?>
            </form>
          </div>
        </div>
      </div>
