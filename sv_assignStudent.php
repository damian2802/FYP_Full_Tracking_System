...
<html lang="en">
  ...
  <body>
    ...
    <!-- Content -->
    <div class="container-fluid">
    <h2 class="mt-3 py-3 px-5 text-left">Assigned Student</h2>
    <div class="container">
    <table class="table table-striped table-hover">
        ...
        <tbody>
        <?php
        $select = mysqli_query($conn,"SELECT * FROM students JOIN projectdetails ON students.matricNo = projectdetails.matricNo WHERE assignedSv='$activeuser'");
        ...
        while($row = mysqli_fetch_array($select)){
            ...
            echo"
            <tr onclick=\"window.location='sv_fypProgress.php?userid=".$matricNo."'\">
                <td>$matricNo</td>
                <td>$studentName</td>
                <td>$projectTitle</td>
                <td>$projectScope</td>
                <td>$projectSubmission</td>
