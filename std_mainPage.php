    ...
    <div class="container">
       ...
       <div class="row">
              <div class="col bg-light w-20 h-20 p-5 m-5 text-center">
                <img src="assets/iconmonstr-school-28-240.png" class="img-fluid align-items-center" alt="" width="120"><br>
                <a href="std_svAssigning.php">Supervisor</a>
            </div>
            <div class="col bg-light w-20 h-20 p-5 m-5 text-center">
                <img src="assets/iconmonstr-document-thin-240.png" class="img-fluid align-items-center" alt="" width="120"><br>
                <a href="<?php if($row['assignedSV'] == "NA") {echo"std_svAssigning.php";}else{echo"std_fypProgress.php";}?>">FYP 1 & FYP 2 Progress</a>
            </div>
            <div class="col bg-light w-20 h-20 p-5 m-5 text-center">
                <img src="assets/iconmonstr-info-10-240.png" class="img-fluid align-items-center" alt="" width="120"><br>
                <a href="std_fypinfo.php">FYP Schedule/Information</a>
            </div>
      </div>
    </div>
